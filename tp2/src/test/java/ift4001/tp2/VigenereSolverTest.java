...
public class VigenereSolverTest {
	...
	private static final String PLAIN_TEXT_BAD_DIST_OF_LETTER = "ZJXQKB ZJXQKB ZJXQKB ZJXQKB ZJXQKB ZJXQKB ZJXQKB";
    ...
    public void CaesarCipher_WithGoodFrequenciesDist_returnsExpectedResult() {
    	Vigenere vigenere = new Vigenere(PLAIN_TEXT_GOOD_DIST_OF_LETTER, Language.ENGLISH);
        String encrypText = vigenere.encrypt("G");
    ...
    @Test
    public void CaesarCipher_WithBadFrequenciesDist_returnsExpectedResult()  {
    	Vigenere vigenere = new Vigenere(PLAIN_TEXT_BAD_DIST_OF_LETTER, Language.ENGLISH);
        String encrypText = vigenere.encrypt("G");
