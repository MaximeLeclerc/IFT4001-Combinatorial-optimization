...
\begin{document}
	...
	\section{Introduction}
		...
		Ce rapport sera séparé en plusieurs parties. Nous commencerons par faire une description du problème. Ensuite, nous proposerons des approches pour résoudre le problème suivi par un protocole d'expérimentation. La rapport sera finalisé avec les résultats ainsi qu'une discussion sur ces résultats.
