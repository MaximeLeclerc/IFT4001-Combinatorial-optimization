...
\begin{document}
	...
	\section{Approche proposée}
		...
		\subsection{Amélioration des heuristiques}
			Pour tenter d'améliorer les performances du solveur, nous avons créé une nouvelle heuristique adapté au modèle.
			...
			\subsubsection{Stratégie pour choisir la variable}
				...
				De cette façon, la variable associée au caractère le plus fréquent est aussi celle qui assigne le plus de variable à une valeur (toutes les autres occurrences du caractère).
