...
\begin{document}
    ...
    \section{Protocole d'expérimentation}
			...
			\smallskip La deuxième instance est une instance qui est considéré comme étant un message
			...
			La troisième instance est une instance qui est considéré comme un long message ayant une très bonne distribution
			de la fréquence des lettres, {\tiny }
    \section{Résultats}
