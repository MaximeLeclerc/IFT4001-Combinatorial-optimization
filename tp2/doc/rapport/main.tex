...
\begin{document}
	...
	\section{Protocole d'expérimentation}
		...
		On prend $n$ qui est la longueur de la chaine à déchiffrer, $c$ qui est la lonueur de la clé et $l$ qui est le nombre de lettre dans l'alphabet.\\
		...
		On déclare une variable pour le texte intermédiaire. Ainsi, la variable $I_i$ représente la valeur de la la lettre de la chaine à la position $i$ pour $1 \leq i \leq l$. Le domaine de chaque variable est l'ensemble des entiers entre $0$ et $2 * (l - 1)$.\\
		
		On déclare une variable pour le texte intermédiaire. Ainsi, la variable $I_i$ représente la valeur de la la lettre de la chaine à la position $i$ pour $1 \leq i \leq l$. Le domaine de chaque variable est l'ensemble des entiers entre $0$ et $2 * (l - 1)$.\\
		
		On déclare une variable pour le texte brut. Ainsi, la variable $B_i$ représente la valeur de la la lettre de la chaine à la position $i$ pour $1 \leq i \leq l$. Le domaine de chaque variable est l'ensemble des entiers entre $0$ et $l - 1$.\\
