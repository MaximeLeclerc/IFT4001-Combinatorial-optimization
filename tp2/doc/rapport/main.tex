	...
	\section{Approche proposée}
		...
		\subsection{Amélioration des heuristiques}
			...
			\subsubsection{Stratégie pour choisir la variable}
				...
				Ensuite, elle place tous les indices des caractères $c \in C$ dans une liste, dans l'ordre de celui qui a le plus d'occurences pour l'une des $k$ sous-chaînes.
				Ces sous-chaînes commencent aux différents indices $[0...k-1]$ dans $C$ et elles contiennent toutes les caractères à des bonds de $k$.
				...
				De cette façon, la variable associée au caractère le plus fréquent est aussi celle qui assigne le plus de variables à une valeur (toutes les autres occurences du caractère).
				...
				On trouve alors que le caractère le plus présent est \emph{B} avec 4 occurences.
				...
				Pour $S_1$, le caractère le plus fréquent est \emph{A} avec $3$ occurences. \\
				Pour $S_2$, il s'agit plutôt de \emph{C} avec 3 occurences.
			...
			\subsubsection{Stratégie pour choisir la valeur}
				Nous avons déterminé les lettres les plus utilisées pour un language.
				Par example, pour l'anglais, on a dans l'ordre les lettres suivantes: \\
				e,t,a,o,i,n,s,h,r,d,l,c,u,m,w,f,g,y,p,b,v,k,j,x,q,z \\
				Cette infomation est passée en paramètre pour construire la stratégie.
