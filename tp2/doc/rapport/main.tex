...
\begin{document}
    ...
    \section{Résultats}
			\noindent{Première instance : Retour arrière : 219 421,Temps de réponse : 93,992 secondes, Nombre de solution trouvé : 158, Présent dans les solutions retournées : Oui} \\
			Deuxième instance : \\
			Avec une clé de 1 : Retour arrière : 55,Temps de réponse : 0,373 secondes, Nombre de solution trouvé : 21, Présent dans les solutions retournées : Oui \\
			Avec une clé de 2 : Retour arrière : 1 369,Temps de réponse : 1,467 secondes, Nombre de solution trouvé : 82, Présent dans les solutions retournées : Oui \\
			Avec une clé de 3 : Retour arrière : 61 985,Temps de réponse : 8,274 secondes, Nombre de solution trouvé : 121, Présent dans les solutions retournées : Oui \\
			Avec une clé de 4 : Retour arrière : 219 421,Temps de réponse : 93,992 secondes, Nombre de solution trouvé : 158, Présent dans les solutions retournées : Oui \\
			Avec une clé de 5 : Retour arrière : 219 421,Temps de réponse : 93,992 secondes, Nombre de solution trouvé : 158, Présent dans les solutions retournées : Oui \\

			\noindent{Troisième instance :} \\
			Avec une clé de 1 : Retour arrière : 51 ,Temps de réponse : 1,018 secondes, Nombre de solution trouvé : 18, Présent dans les solutions retournées : Oui \\
			Avec une clé de 2 : Retour arrière : 1 323 ,Temps de réponse : 4,099 secondes, Nombre de solution trouvé : 65, Présent dans les solutions retournées : Oui \\

			\noindent{Quatrième instance :} \\
			Avec une clé de 1 : Retour arrière : 63 ,Temps de réponse : 0,198 secondes, Nombre de solution trouvé : 17, Présent dans les solutions retournées : Non \\
    \section{Discussion}
